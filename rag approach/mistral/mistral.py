...
def dense_process_test_paper(row, vectorstore, feature_sets, feature_set_index, selected_features, k, model_name="mistral"):
...
def generate_results(file_path, model_name="mistral"):
